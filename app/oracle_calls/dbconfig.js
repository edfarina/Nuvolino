...
module.exports = {
  user          : process.env.NODE_ORACLEDB_USER || "sql11172989",
  user_log          : process.env.NODE_ORACLEDB_USER || "ATLAS_MUON_NSW_MM_READER",
  //user_log_w          : process.env.NODE_ORACLEDB_USER || "ATLAS_MUON_NSW_MM_LOG_W",
  user_log_w          : process.env.NODE_ORACLEDB_USER || "ATLAS_MUON_NSW_MM_PCB",
  
  // Instead of hard coding the password, consider prompting for it,
  // passing it in an environment variable via process.env, or using
  // External Authentication.
  password      : process.env.NODE_ORACLEDB_PASSWORD || "gxPNMb9mdQ",
  password_log      : process.env.NODE_ORACLEDB_PASSWORD || "NSWreadme2016",
  //password_log_w      : process.env.NODE_ORACLEDB_PASSWORD || "IhkAwImjwas...2",
  password_log_w      : process.env.NODE_ORACLEDB_PASSWORD || "nswPCB20162017",
  // For information on connection strings see:
  // https://github.com/oracle/node-oracledb/blob/master/doc/api.md#connectionstrings
  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "sql",
